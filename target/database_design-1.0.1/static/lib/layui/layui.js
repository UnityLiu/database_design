  ...
  (r.prototype.cache = n),
    ...
    (r.prototype.use = function (t, r, o, c) {
        ...
        ('load' === t.type ||
          ...
          (function o() {
            return ++h > (1e3 * n.timeout) / 4
              ? i(v + ' is not a valid module', 'error')
      ...
      if (
        ...
        (n.host =
          n.host ||
          (y.match(/\/\/([\s\S]+?)\//) || ['//' + location.host + '/'])[0]),
        0 === t.length || (layui['layui.all'] && l[v]))
      )
        return p(), f;
      var m =
        (l[v]
      ...
      for (
        var n = 0,
          r =
            'object' == typeof t
              ? [t]
              : ((this.selector = t), e.querySelectorAll(t || null));
        n < r.length;
        n++
      )
        this.push(r[n]);
        ...
        'function' == typeof r &&
          !(function f(t) {
            ...
            return ++l > 1e4 / o
              ...
              : void (1989 === parseInt(n.getStyle(i, 'width'))
                  ? (t === s && i.removeAttribute('lay-status'),
                    i.getAttribute('lay-status') === s ? setTimeout(f, o) : r())
  ...
  (l.formatArr = function (e) {
    ...
    (T.prototype.init = function () {
      ...
      (a.elem = lay(a.elem)),
        ...
        a.elem[0] &&
          ...
          (t.format = l.formatArr(a.format)),
          (t.EXP_IF = ''),
          (t.EXP_SPLIT = ''),
          lay.each(t.format, function (e, a) {
            var n = new RegExp(D).test(a)
              ? '\\d{' +
                (function () {
    ...
    (T.prototype.render = function () {
      ...
      if (
        ...
        lay(d).html(
          (function () {
            ...
            return (
              ...
              (t.range || 'datetime' !== t.type) &&
                e.push(
                  '<span class="' + v + '" title="' + a.preview + '"></span>'
                ),
              lay.each(t.btns, function (e, l) {
                var r = a.tools[l] || 'btn';
                (t.range && 'now' === l) ||
                  (n &&
                    'clear' === l &&
                    (r = 'cn' === t.lang ? '\u91cd\u7f6e' : 'Reset'),
                  i.push(
                    '<span lay-type="' +
                      l +
                      '" class="laydate-btns-' +
        ...
        'styleSheet' in c
          ? (c.setAttribute('type', 'text/css'), (c.styleSheet.cssText = u))
          : (c.innerHTML = u),
      ...
      (i.thisId = t.id),
        ...
        'function' == typeof t.ready &&
          t.ready(lay.extend({}, t.dateTime, { month: t.dateTime.month + 1 })),
        e.preview();
    }),
    ...
    (T.prototype.checkDate = function (e) {
            ...
            lay.each(n.format, function (o, s) {
              ...
              t[o].length < s.length && (a = !0),
                /yyyy|y/.test(s)
                  ...
                  ? (y < 1 && ((y = 0), (a = !0)),
                    (e.hours = y),
                    l.range && (n[r[i]].hours = y))
                  : /mm|m/.test(s)
                  ? (y < 1 && ((y = 0), (a = !0)),
                    (e.minutes = y),
                    l.range && (n[r[i]].minutes = y))
                  : /ss|s/.test(s) &&
                    (y < 1 && ((y = 0), (a = !0)),
                    (e.seconds = y),
                    l.range && (n[r[i]].seconds = y));
            }),
            m(e);
        };
            ...
            lay.extend(
              ...
              (function () {
                ...
                return (
                  'year' === l.type
                    ? (e.year = t.year + 1)
                    : 'time' !== l.type && ((e.year = a[0]), (e.month = a[1])),
                  ('datetime' !== l.type && 'time' !== l.type) ||
      ...
      u(),
          ...
          ? n.EXP_IF.test(y)
            ? l.range
              ? ((y = y.split(' ' + n.rangeStr + ' ')),
                lay.each([l.dateTime, n.endDate], function (e, t) {
                  c(t, y[e], e);
                }))
              : c(o, y)
            : (n.hint(
                r.formatError[0] +
                  (l.range
                    ? l.format + ' ' + n.rangeStr + ' ' + l.format
                    : l.format) +
                  r.formatError[1]
              ),
              (a = !0))
          : y && y.constructor === Date
          ? (l.dateTime = n.systemDate(y))
          : ((l.dateTime = n.systemDate()),
            delete n.startTime,
            delete n.endDate,
            u(),
            delete n.endTime),
        ...
        a &&
          y &&
          n.setValue(l.range ? (n.endDate ? n.parse() : '') : n.parse());
      var h = function (e) {
        return n.newDate(e).getTime();
      };
      return (
        (h(o) > h(l.max) || h(o) < h(l.min)) &&
          (o = l.dateTime = lay.extend({}, l.min)),
        l.range &&
          (h(n.endDate) < h(l.min) || h(n.endDate) > h(l.max)) &&
          (n.endDate = lay.extend({}, l.max)),
        e && e(),
        n
      );
    }),
    ...
    (T.prototype.calendar = function (e, t, a) {
      ...
      return (
        m.year < d[0] && ((m.year = d[0]), o.hint(u.invalidDate)),
        m.year > d[1] && ((m.year = d[1]), o.hint(u.invalidDate)),
        o.firstDate || (o.firstDate = lay.extend({}, m)),
        c.setFullYear(m.year, m.month, 1),
        (n = c.getDay()),
        (l = i.getEndDate(m.month || 12, m.year)),
        (r = i.getEndDate(m.month + 1, m.year)),
          ...
          (t = lay(t)),
            ...
            e < n
              ? ((i = l - n + e),
                ...
                (a = o.getAsYM(m.year, m.month, 'sub')))
              : e >= n && e < r + n
              ? ((i = e - n), i + 1 === m.date && t.addClass(s))
              : ((i = e - r - n),
                t.addClass('laydate-day-next'),
                (a = o.getAsYM(m.year, m.month))),
            a[1]++,
            (a[2] = i + 1),
        ...
        'cn' === y.lang
          ? (lay(g[0])
            ...
            lay(g[1])
              .attr('lay-type', 'month')
              .html(m.month + 1 + ' \u6708'))
          : (lay(g[0]).attr('lay-type', 'month').html(u.month[m.month]),
          ...
          (y.range
            ? e &&
              ...
              'time' === y.type
                ...
                : o.setBtnStatus(!0))
            : ((o.listYM = [[m.year, m.month + 1]]), o.list(y.type, 0))),
        y.range && 'init' === a && !e && o.calendar(o.endDate, 1),
        y.range ||
          o.limit(lay(o.footer).find(f), null, 0, [
            'hours',
            'minutes',
            'seconds',
          ]),
    ...
    (T.prototype.list = function (e, t) {
      ...
      if ((D[0] < 1 && (D[0] = 1), 'year' === e)) {
        ...
        lay.each(new Array(12), function (e) {
          var i = lay.elem('li', { 'lay-ym': e }),
            r = { year: D[0], month: e };
          e + 1 == D[1] && lay(i).addClass(s),
            (i.innerHTML = l.month[e] + (v ? '\u6708' : '')),
            o.appendChild(i),
        ...
        var C = function () {
          lay(o)
              ...
              lay(n)
                ...
                .each(function (n, i) {
                  a.limit(
                    ...
                    [
                      { hours: n },
                      { hours: a[w].hours, minutes: n },
                      { hours: a[w].hours, minutes: a[w].minutes, seconds: n },
                    ][e],
                    t,
                    [
                      ['hours'],
            ...
            n.range ||
              a.limit(lay(a.footer).find(f), a[w], 0, [
                'hours',
                'minutes',
                'seconds',
              ]);
        ...
        n.range
          ? a[w] || (a[w] = 'startTime' === w ? i : a.endDate)
          : (a[w] = i),
      ...
      if (
        (h && u.removeChild(h), u.appendChild(o), 'year' === e || 'month' === e)
      )
          ...
          lay(o)
            ...
            .on('click', function () {
              ...
              if (!lay(this).hasClass(y)) {
                0 === t
                  ? ((i[e] = l), a.limit(lay(a.footer).find(f), null, 0))
                  : (a.endDate[e] = l);
        ...
        .on('keydown', function (e) {
          if (i.thisId) {
            ...
            a &&
              13 === e.keyCode &&
              t('#' + a.elemID)[0] &&
              a.elemID === T.thisElemDate &&
              (e.preventDefault(), t(a.footer).find(f)[0].click());
          }
        }),
    ...
    (i.parse = function (e, t, a) {
      return (
        (e = e || {}),
        'string' == typeof t && (t = l.formatArr(t)),
        (t = (t || []).concat()),
    ...
    b = {
      tabClick: function (t, a, s, o) {
        ...
        ('javascript:;' !== d.attr('href') && '_blank' === d.attr('target')) ||
          ...
          layui.event.call(this, e, 'tab(' + y + ')', { elem: c, index: a });
      },
